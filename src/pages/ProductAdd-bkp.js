                ...
                <div class='row'>
                    <div class='col-4 offset-4 bg-warning-subtle mt-2'>
                        ...
                        <div class='mb-2 mt-2'>
                            ...
                            <div class='mb-2'>
                                <input class='form-control' onKeyUp={(e) => { setDescription(e.target.value) }} id='catid' placeholder='Product Description'></input>
                            </div>
                            <div class='mb-2'>
                            ...
                            <div class='mb-2 d-flex gap-2'>
                                ...
                                <button class='form-control bg-warning' type='reset'>Reset</button>
                            </div>
                        </form>
                        <div class='mb-2'>
